...
for i = 1:opts.MaxIter+1
    ...
    [ys,~,~,Fs,~,~,chords] = util.get_lift_dist(obj,resFile,[[obj.MainWingRHS.Name],[obj.MainWingLHS.Name]]);
...
obj.e_theo = Lds(1).Meta.CL_wing^2/(pi*obj.AR*Lds(1).Meta.CDi_wing);
end
