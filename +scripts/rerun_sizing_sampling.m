...
for i = 1:nSamples
    ADP.AR = inputUnscaled(i,1);
    ADP.HingeEta = inputUnscaled(i,2);
    ADP.FlareAngle = inputUnscaled(i,3);
    ADP.ADR.M_c = inputUnscaled(i,4);
    ADP.SweepAngle = inputUnscaled(i,5);
    %% ============================ Re-run Sizing =============================
    % conduct sizing
    ...
    if printoutput  
        ...
        outArray(i,:) = [meta.Fuel_trip,C_ops];
    end
end
